         ...
         <AdminLayout>
            ...
            <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
                <div className="flex justify-between items-center mb-6 border-b pb-4">
                    <h1 className="text-2xl font-bold text-gray-800">Thêm Thể loại</h1>
                    <Link href="/admin/categories" className="text-gray-500 hover:underline">&larr; Quay lại</Link>
                </div>

                <form onSubmit={submit} className="space-y-4">
                    <div>
                        <label className="block text-sm font-semibold mb-1">Tên thể loại <span className="text-red-500">*</span></label>
